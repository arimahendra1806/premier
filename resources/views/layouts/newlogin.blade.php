...
<body style="font-family: 'PT Sans Narrow', sans-serif;">
    ...
    <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-10">
        <div class="right-content-3-10">
          ...
          <h3 class="title-text-content-3-10">Masuk untuk lanjut</h3>
          <p class="caption-text-content-3-10">Tolong masuk menggunakan akun yang<br>
            sudah teregritasi dalam website.</p>
          <form style="margin-top: 1.5rem;" action="/postlogin" method="post">
          	@csrf
            ...
            <div style="margin-top: 1rem;">
              ...
              <div class="d-flex w-100 div-input-content-3-10">
                ...
                <input class="input-field-content-3-10 @error('password') is-invalid @enderror" type="password" name="password" id="password" placeholder="Kata Sandi" minlength="8" required autocomplete="current-password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <button class="btn btn-fill-content-3-10 d-block w-100" type="submit">Masuk Akun Saya</button>
          </form>
          <p class="text-center bottom-caption-content-3-10">Belum punya akun?
            <span class="green-bottom-caption-content-3-10" onclick="btnRegister()">Registrasi Disini</span>
          </p>
        </div>
      </div>
	...
	<script>
      function btnRegister(url){
          var x = window.open('/newregister','_self');
          x.focus();
      }
    </script>
</body>
