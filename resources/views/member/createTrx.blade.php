...
<div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            @if( $data == 1)
            <h2 class="h5 no-margin-bottom">Booking Lapangan</h2>
            @else
            <h2 class="h5 no-margin-bottom">Detail Member</h2>
            @endif
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="messages-block block">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="title"><strong class="d-block">Booking Lapangan Anda Sekarang</strong></div>
                      </div>
                    </div>
                  </div>
                    <form action="/member/transaksi/store" method="POST">
                    @csrf
                     <div class="form-group">
                        <div class="row">
                          <div class="col-lg-3">
                          ...
                          @foreach($idMember as $idM)
                            <input type="text" id="id_member" name="id_member" class="form-control" value="{{$idM->id_member}}" hidden="">
                          @endforeach
                          <input type="text" id="id_admin" name="id_admin" class="form-control" value="AD1" hidden="">
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend"><span class="input-group-text">Rp</span></div>
                              <input type="text" id="total_booking" name="total_booking" class="form-control" readonly="">
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <label class="form-control-label">Pembayaran</label>
                            <select name="pembayaran" id="pembayaran" class="form-control mb-3 mb-3">
                              <option value="">-- Pilih Status --</option>
                              <option value="LinkAja">LinkAja</option>
                              <option value="Ovo">Ovo</option>
                            </select>
                          </div>
                          <input type="text" id="total_bayar" name="total_bayar" class="form-control"value="0" hidden="">
                          <input type="text" id="sisa_bayar" name="sisa_bayar" class="form-control" value="0" hidden="">
                          <input type="text" id="status_booking" name="status_booking" class="form-control" value="Menunggu" hidden="">
              ...
              <div class="col-lg-12">
                <div class="messages-block block">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="title"><strong class="d-block">Tambah Detail Profil Member</strong></div>
                        <span><p style="color: red"><b>Mohon lengkapi data anda sebelum memesan lapangan</b></p></span>
                      </div>
                    </div>
                    <form action="/member/detailUser/store" method="POST">
                    @csrf
                      <div class="row">
                        <div class="col-lg-8">
                          <label class="form-control-label">ID Member</label>
                          <input type="text" id="id_member" name="id_member" class="form-control" value="MB<?php echo(rand(1000,9999)) ?>" readonly="">
                        </div>
                      </div>
                      <input type="text" id="id_user" name="id_user" class="form-control" value="{{Auth::user()->id_user}}" hidden="">
                      <div class="row">
                        <div class="col-lg-8">
