...
<div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Kontak Admin</h2>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="messages-block block">
                  <img src="../../assets/images/premier/qr-code.png" style="width: 637px; height: 325px; padding-left: 312px;">
                  <div class="title" style="text-align: center; padding-top: 1em;">
                    <strong>Scan Me</strong><br>
                  </div>
                  <div class="container-fluid">
                      <h2 class="h5 no-margin-bottom">Kontak Admin Premier Futsal Kediri</h2>
                      <p style="padding-top: 1em">
                        Kami menyediakan layanan tanya jawab melalui media whatsapp Premier Futsal.<br>
                        Dengan nomor layanan <a href="https://wa.link/g61r4o">081222333444</a>, jam pelayanan 08.00 - 20.00
                      </p>
                      <div class="row">
                        <div class="col-sm-1" onclick="btnFb();">
                            <svg class="social-media-c-footer-2-4 social-media-left-footer-2-4" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-sm-1">
                          <svg class="social-media-c-footer-2-4 social-media-center-1-footer-2-4" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#999999"/>
                            <g clip-path="url(#clip0)">
                        ...
                        <div class="col-sm-1">
                          <svg class="social-media-p-footer-2-4 social-media-center-2-footer-2-4" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-sm-1">
                          <svg class="social-media-c-footer-2-4 social-media-right" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#999999"/>
                            <g clip-path="url(#clip0)">
...
@push('js')
  <script>
      function btnFb(url){
          var x = window.open('https://web.facebook.com','_self');
          x.focus();
      }
    </script>
@endpush
