...
<div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Laporan Bulanan Booking Online</h2>
          </div>
        </div>
	                            ...
	                            <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-info" 
                                        href="/admin/showLaporan/{{$ndata->id_transaksi}}" role="button">
                                        Show      
                                    </a>
                                  </td>
	                            </tr>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
     <script>
          ...
          $(document).ready(function() {
              ...
              $('#exportpdf').attr('href', '/admin/laporan/pdf/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
              ...
              $('#created_at').daterangepicker({
                  ...
                  $('#exportpdf').attr('href', '/admin/laporan/pdf/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
              })
          })
      </script>
@endpush