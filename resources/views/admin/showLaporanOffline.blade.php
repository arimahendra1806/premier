...
<div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Detail Transaksi Offline</h2>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <span class="d-block">Detail transaksi : {{$ndata->id_transaksi}} | An : {{$ndata->member_offline}} </span></div>
                  <div class="block-body">
                      ...
                      <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="pembayaran" name="pembayaran" class="form-control" value="{{$ndata->pembayaran}}" readonly="">
                            </div>
                            <div class="col-lg-6">
...
<script>
  function btnKembali(url){
    var x = window.open('/admin/laporanOffline','_self');
    x.focus();
  }
</script>
@endpush
